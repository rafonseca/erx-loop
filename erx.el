;;; erx.el --- Loop macros for text matching  -*- lexical-binding: t; -*-
...
;;; Commentary: erx stands for Extended RX. The `erx-loop' macro
;;; allows to nest regex matching while binding regions and their
;;; contents in a concise way.


;; TODO: make package
;; TODO: provide cl-loop equivalent
;;; Code:
...
(defun erx--star-symbol (sym)
  "Returns new symbol prefixed with *"  
  (-it-> sym
	 (symbol-name it)
	 (concat "*" it)
	 (intern it)))
